...
-- Core statuses
('all', 'All', '📄', 'gray', 'View all job applications', 0, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-gray-100", "text": "text-gray-800"}', 'neutral', '[]', null, null, '📄', 'none', false, false, 'System'),
('saved', 'Saved', '📌', 'yellow', 'Job saved for later consideration', 1, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-yellow-100", "text": "text-yellow-800"}', 'neutral', '["saved"]', 'Review this job application and decide whether to apply', 'Check application requirements', '📌', 'none', false, false, 'Neutral'),
('applied', 'Applied', '📤', 'green', 'Application submitted, waiting for response', 2, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-green-100", "text": "text-green-800"}', 'positive', '["applications", "active"]', 'It''s been 10 days since you applied. Follow-up recommended if no response', 'Send follow-up email', '📤', 'none', false, false, 'Positive'),
('interview', 'Interview', '🗓️', 'blue', 'Interview scheduled or in progress', 3, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-blue-100", "text": "text-blue-800"}', 'positive', '["applications", "active", "interviews"]', 'Prepare for the interview by researching the company and practicing common questions', 'Research company and prepare questions', '🗓️', 'pulse', false, false, 'Positive'),
('offer', 'Offer', '💼', 'purple', 'Job offer received', 4, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-purple-100", "text": "text-purple-800"}', 'positive', '["applications", "offers"]', 'Congratulations! Review the offer details carefully before deciding', 'Review offer terms and negotiate if needed', '💼', 'bounce', false, false, 'Positive'),
('rejected', 'Rejected', '🚫', 'red', 'Application rejected by company', 5, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-red-100", "text": "text-red-800"}', 'negative', '["applications", "rejected"]', 'Don''t get discouraged. Learn from the experience and continue applying', 'Review feedback and improve next application', '🚫', 'none', false, false, 'Negative'),

-- Extended statuses for future-proofing
('upcoming', 'Upcoming', '🕒', 'sky', 'Application deadline approaching', 6, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-sky-100", "text": "text-sky-800"}', 'neutral', '["upcoming"]', 'Complete and submit your application before the deadline', 'Finish application preparation', '🕒', 'pulse', false, true, 'Neutral'),
('in_review', 'In Review', '👀', 'indigo', 'Application under company review', 7, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-indigo-100", "text": "text-indigo-800"}', 'neutral', '["applications", "active"]', 'Your application is being reviewed. This typically takes 1-2 weeks', 'Wait for response or prepare follow-up', '👀', 'none', false, false, 'Neutral'),
('assessment', 'Assessment', '📝', 'amber', 'Technical assessment or test required', 8, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-amber-100", "text": "text-amber-800"}', 'neutral', '["applications", "active"]', 'Complete the assessment to the best of your ability', 'Complete assessment test', '📝', 'pulse', false, false, 'Neutral'),
('referral', 'Referral Sent', '📨', 'teal', 'Referral request sent to contact', 9, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-teal-100", "text": "text-teal-800"}', 'positive', '["applications", "active"]', 'Follow up with your contact if you don''t hear back within a week', 'Contact referral person', '📨', 'none', false, true, 'Positive'),
('autopilot', 'Auto-Applied', '🤖', 'emerald', 'Automatically applied via AI system', 10, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-emerald-100", "text": "text-emerald-800"}', 'system', '["applications", "active"]', 'Monitor the application status and prepare for potential interviews', 'Monitor application progress', '🤖', 'pulse', false, true, 'System'),
('withdrawn', 'Withdrawn', '↩️', 'zinc', 'Application withdrawn by candidate', 11, '{"chip": "px-3 py-1 rounded-full text-sm font-medium flex items-center gap-2", "bg": "bg-zinc-100", "text": "text-zinc-800"}', 'negative', '["applications", "withdrawn"]', 'Consider why you withdrew and use this insight for future applications', 'Reflect on withdrawal reasons', '↩️', 'none', false, false, 'Negative')
